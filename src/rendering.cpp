...
VkRenderingInfoKHR rendering_info_create(VkRect2D render_area, std::span<VkRenderingAttachmentInfoKHR> color_attachments,
...
void rendering_end(VkCommandBuffer command_buffer) { vkCmdEndRenderingKHR(command_buffer); }
