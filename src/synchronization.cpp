...
VkBufferMemoryBarrier buffer_memory_barrier(VkBuffer buffer, uint32_t src_queue_family_index, uint32_t dst_queue_family_index,
    ...
    buffer_mem_barrier.srcAccessMask       = src_access_flags;
    buffer_mem_barrier.dstAccessMask       = dst_access_flags;
...
VkMemoryBarrier memory_barrier(VkAccessFlags src_access, VkAccessFlags dst_access) {
...
VkMemoryBarrier2KHR global_memory_barrier_2(VkPipelineStageFlags2KHR src_stages, VkAccessFlags2KHR src_access, VkPipelineStageFlags2KHR dst_stages,
