...
void submit_info_builder_set_pNext_1(SubmitInfoBuilder* builder, const void* pNext) { builder->submit_info_1.pNext = pNext; }
...
void submit_info_builder_set_submit_flags(SubmitInfoBuilder* builder, VkSubmitFlagsKHR flags) { builder->submit_info_2.flags = flags; }

void submit_info_builder_set_pNext_2(SubmitInfoBuilder* builder, const void* pNext) { builder->submit_info_2.pNext = pNext; }

void submit_info_builder_clear(SubmitInfoBuilder* builder) { *builder = SubmitInfoBuilder{}; }
