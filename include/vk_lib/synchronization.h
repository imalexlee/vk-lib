...
[[nodiscard]] VkImageMemoryBarrier image_memory_barrier(VkImage image, const VkImageSubresourceRange* subresource_range, VkImageLayout old_layout,
                                                        ...
                                                        VkAccessFlags dst_access_flags = VK_ACCESS_SHADER_WRITE_BIT | VK_ACCESS_SHADER_READ_BIT,
...
[[nodiscard]] VkMemoryBarrier memory_barrier(VkAccessFlags src_access = VK_ACCESS_SHADER_WRITE_BIT,
                                             VkAccessFlags dst_access = VK_ACCESS_SHADER_WRITE_BIT | VK_ACCESS_SHADER_READ_BIT);
...
[[nodiscard]] VkBufferMemoryBarrier2KHR buffer_memory_barrier_2(VkBuffer buffer, uint32_t src_queue_family_index, uint32_t dst_queue_family_index,
                                                                ...
                                                                VkAccessFlags2KHR     dst_access_flags = VK_ACCESS_2_SHADER_WRITE_BIT_KHR |
                                                                                                     VK_ACCESS_2_SHADER_READ_BIT_KHR,
                                                                uint64_t offset = 0, uint64_t size = VK_WHOLE_SIZE, const void* pNext = nullptr);

[[nodiscard]] VkMemoryBarrier2KHR global_memory_barrier_2(VkPipelineStageFlags2KHR src_stages, VkAccessFlags2KHR src_access,
