...
void memory_barrier_multi_insert2(VkCommandBuffer command_buffer,
...
void image_memory_barrier_multi_insert2(VkCommandBuffer command_buffer,
                                        std::span<VkImageMemoryBarrier2> image_barriers,
                                        VkDependencyFlags dependency_flags = 0);

void buffer_barrier_multi_insert2(VkCommandBuffer command_buffer,
                                  std::span<VkBufferMemoryBarrier2> buffer_barriers,
                                  VkDependencyFlags dependency_flags = 0);

void global_memory_barrier_multi_insert2(VkCommandBuffer command_buffer,
                                         std::span<VkMemoryBarrier2> memory_barriers,
                                         VkDependencyFlags dependency_flags = 0);
...
void buffer_memory_barrier_insert2(VkCommandBuffer command_buffer,
                                   const VkBufferMemoryBarrier2* buffer_barrier,
                                   VkDependencyFlags dependency_flags = 0);
