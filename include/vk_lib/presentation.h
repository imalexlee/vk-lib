...
[[nodiscard]] VkPresentInfoKHR present_info_batch(std::span<VkSwapchainKHR> swapchains, std::span<uint32_t> image_indices,
...
swapchain_create_info(VkSurfaceKHR surface, uint32_t min_image_count, VkFormat format, VkColorSpaceKHR color_space, VkExtent2D extent,
                      ...
                      VkSharingMode sharing_mode = VK_SHARING_MODE_EXCLUSIVE, std::span<uint32_t> queue_family_indices = {},
