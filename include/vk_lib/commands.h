...
VkResult command_buffer_begin(VkCommandBuffer command_buffer,
...
void submit_info_builder_batch_set_semaphores_1(SubmitInfoBuilder* builder,
                                                std::span<VkSemaphore> wait_semaphores,
                                                std::span<VkPipelineStageFlags>
...
void submit_info_builder_batch_set_command_buffers_1(SubmitInfoBuilder* builder,
                                                     std::span<VkCommandBuffer> command_buffers);

void submit_info_builder_set_command_buffer_1(SubmitInfoBuilder* builder,
                                              VkCommandBuffer command_buffer);

void submit_info_builder_set_pNext_1(SubmitInfoBuilder* builder, const void* pNext);

void submit_info_builder_batch_set_semaphore_infos_2(SubmitInfoBuilder* builder,
                                                     std::span<VkSemaphoreSubmitInfoKHR>
                                                     wait_semaphore_submit_infos,
                                                     std::span<VkSemaphoreSubmitInfoKHR>
                                                     signal_semaphore_submit_infos);

void submit_info_builder_set_semaphore_infos_2(SubmitInfoBuilder* builder,
                                               const VkSemaphoreSubmitInfoKHR*
...
[[nodiscard]] VkSubmitInfo2KHR submit_info_builder_create_submit_info_2(
    const SubmitInfoBuilder* builder);

VkResult queue_batch_submit(VkQueue queue, std::span<VkSubmitInfo> submit_infos,
