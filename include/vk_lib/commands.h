...
[[nodiscard]] VkSubmitInfo submit_info_batch_create(std::span<VkCommandBuffer> command_buffers, std::span<VkSemaphore> wait_semaphores = {},
                                                    std::span<VkPipelineStageFlags> wait_semaphore_stage_flags = {},
                                                    std::span<VkSemaphore> signal_semaphores = {}, const void* pNext = nullptr);

[[nodiscard]] VkSubmitInfo submit_info_create(const VkCommandBuffer* command_buffer, const VkSemaphore* wait_semaphore = nullptr,
...
[[nodiscard]] VkSubmitInfo2KHR submit_info_2_batch_create(std::span<VkCommandBufferSubmitInfoKHR> command_buffer_submit_infos,
